...
def VentanaProf(Nombre_Usuario,conexion):
    ...
    #boton1
    imgB1 = PhotoImage(file='image/X.png')
    Button (VentPro,width=250, height=250,command=partial(MenuAltaProf, Nombre_Usuario),border=5,image=imgB1).place(x=100, y=650)
    Label(VentPro,text='Alta Usuario',border=5).place(x=100,y=600)

    #boton2
    imgB2 = PhotoImage(file='image/X.png')
    Button (VentPro, text='Prueba2',width=250, height=250,command=partial(MenuAltaProduct,Nombre_Usuario),border=5,image=imgB2).place(x=845, y=650)
    Label(VentPro,text='Alta Producto',border=5).place(x=845,y=600)

    #boton3
    imgB3 = PhotoImage(file='image/X.png')
    Button (VentPro, text='Prueba2',width=250, height=250, command=partial(MenuListaDB_profe,Nombre_Usuario),border=5,image=imgB3).place(x=1590, y=650)
    Label(VentPro,text='Lista Producto',border=5).place(x=1590,y=600)
